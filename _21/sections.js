      ...
      <section class="bg-surface-container-lowest rounded-xl border border-outline-variant industrial-shadow overflow-hidden">
        <div class="p-6 border-b border-outline-variant flex flex-col md:flex-row justify-between items-stretch md:items-center gap-4">
          ...
          <div class="flex flex-col sm:flex-row gap-3">
            ...
            <!-- Filter Tabs -->
            <div class="flex bg-surface-container p-1 rounded-lg gap-1 text-xs">
              <button onclick="setInvoiceFilter('all')" id="inv-filter-all" class="lang-text px-3 py-1.5 rounded bg-secondary-container text-on-secondary-container font-bold transition-all" data-ar="الكل" data-en="All">الكل</button>
              <button onclick="setInvoiceFilter('Paid')" id="inv-filter-paid" class="lang-text px-3 py-1.5 rounded text-on-surface-variant hover:text-primary font-bold transition-all" data-ar="مدفوعة" data-en="Paid">مدفوعة</button>
              <button onclick="setInvoiceFilter('Pending')" id="inv-filter-pending" class="lang-text px-3 py-1.5 rounded text-on-surface-variant hover:text-primary font-bold transition-all" data-ar="معلقة" data-en="Pending">معلقة</button>
              <button onclick="setInvoiceFilter('Overdue')" id="inv-filter-overdue" class="lang-text px-3 py-1.5 rounded text-on-surface-variant hover:text-primary font-bold transition-all" data-ar="متأخرة" data-en="Overdue">متأخرة</button>
            </div>
          </div>
        </div>
    ...
    <div id="view-fleet" class="view-section transition-all duration-300 hidden">
      ...
      <section class="bg-surface-container-lowest rounded-xl border border-outline-variant industrial-shadow overflow-hidden">
        <div class="p-6 border-b border-outline-variant flex flex-col md:flex-row justify-between items-stretch md:items-center gap-4">
          ...
          <div class="flex bg-surface-container p-1 rounded-lg gap-1 text-xs">
            <button onclick="setFleetFilter('all')" id="fleet-filter-all" class="lang-text px-3 py-1.5 rounded bg-secondary-container text-on-secondary-container font-bold transition-all" data-ar="الكل" data-en="All">الكل</button>
            <button onclick="setFleetFilter('Active')" id="fleet-filter-active" class="lang-text px-3 py-1.5 rounded text-on-surface-variant hover:text-primary font-bold transition-all" data-ar="نشط" data-en="Active">نشط</button>
            <button onclick="setFleetFilter('Maintenance')" id="fleet-filter-maintenance" class="lang-text px-3 py-1.5 rounded text-on-surface-variant hover:text-primary font-bold transition-all" data-ar="صيانة" data-en="Maintenance">صيانة</button>
          </div>
        </div>
        <div class="overflow-x-auto">
          <table class="w-full text-right border-collapse">
